        ...
        <div className=" flex flex-col">
            ...
            >
                <div className="text-center px-4 py-12">
                    <h1 className="text-2xl md:text-3xl font-bold text-white mb-4">Join to Explore Now</h1>
                    ...
                    <div className="max-w-[860px] mx-auto px-14">
                            ...
                            <div className="md:col-span-1 mb-8 mt-5">
                                <div className="mb-4">
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-2xl font-bold text-[#3754A1]">tech.</span>
                                    </div>
                                </div>
                                <p className="text-gray-600 text-[10px] mb-4 font-semibold">
                                    Our customized solutions include residency, health insurance, and strategic financial planning, helping you maximize your earnings while expanding your global opportunities.
                                </p>
                                <div className="flex space-x-3">
                                    <a href="#" className="w-8 h-8 rounded-full bg-[#DEE2FD] flex items-center justify-center text-white">
                                        <span className="sr-only">Facebook</span>
                                        <svg className="w-5 h-5 text-[#3754A1] fill-current" fill="" viewBox="0 0 24 24">
                                    ...
                                    <a href="#" className="w-8 h-8 rounded-full bg-[#DEE2FD] flex items-center justify-center text-white">
                                        ...
                                        <svg className="w-5 h-5 text-[#3754A1]" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex flex-row justify-around space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <ul className="space-y-2 text-xs">
                                            <li><a href="#" className="text-gray-600 hover:text-[#3754A1]">Product Overview</a></li>
                                            <li><a href="#" className="text-gray-600 hover:text-[#3754A1]">Pricing</a></li>
                                            <li><a href="#" className="text-gray-600 hover:text-[#3754A1]">Features</a></li>
                                            <li><a href="#" className="text-gray-600 hover:text-[#3754A1]">Integrations</a></li>
                                            <li><a href="#" className="text-gray-600 hover:text-[#3754A1]">Security</a></li>
                                        </ul>
                                    </div>
                        ...
                        <div className="border-t border-gray-200 pt-1">
                            <div className="flex flex-wrap justify-around items-center">
                                <div className="flex items-center space-x-2 mb-4 md:mb-0">
                                    <div className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center">
                                        <svg className="w-4 h-4 text-[#3754A1] fill-[#DEE2FD]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.948V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                                        </svg>
                                    </div>
                                ...
                                <div className="flex items-center space-x-2 mb-4 md:mb-0">
                                    ...
                                    <span className="text-gray-600 text-xs">Datatech@example.com</span>
                                </div>
                            ...
                            <div className="mt-2 pt-2 border-t border-gray-200 mb-2 bg-[#DEE2FD]">
                                <p className="text-gray-500 text-xs text-center">Copyright 2024 datatech.</p>
                            </div>
                        </div>
                    </div>
                </footer>

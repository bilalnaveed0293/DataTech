            ...
            >
                ...
                <div className="container mx-12 sm:mx-14 md:mx-16 lg:mx-18 xl:mx-20 w-full max-w-[90%] sm:max-w-[85%] md:max-w-2xl lg:max-w-3xl xl:max-w-5xl 2xl:max-w-6xl relative z-10 mb-4 sm:mb-5 md:mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row justify-start gap-3 sm:gap-4 md:gap-6">
                        <button
                            onClick={goToForm}
                            className="w-full sm:w-auto text-[#3754A1] bg-white rounded-lg px-4 py-2 sm:px-3 md:px-4 lg:px-5 sm:py-2.5 md:py-3 lg:py-2 transition duration-300 flex items-center justify-start text-xs sm:text-sm md:text-base lg:text-lg border border-gray-300 cursor-pointer"
                        >

...
const ThreeStepProcess = () => {
  ...
  return (
    <div className="py-12 px-4 bg-white flex flex-col md:flex-row">
      {/* Steps Section */}
        ...
        <div className="relative flex flex-col items-center">
          {steps.map((step, index) => (
            <React.Fragment key={index}>
              <div className="relative flex flex-col items-center max-w-[200px] mb-8">
                {/* Arrow images to connect steps (except for first step) */}
                {index > 0 && (
                  <div className="absolute" style={{
                    width: "100px",
                    height: "80px",
                    top: "-50px",
                    left: index % 2 === 1 ? "180px" : "-80px"
                  }}>
                    {/* Use arrow images instead of SVGs */}
                    <img 
                      src={index % 2 === 1 ? arrowRight : arrowLeft} 
                      alt={index % 2 === 1 ? "Arrow Right" : "Arrow Left"}
